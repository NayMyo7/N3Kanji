        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              final wordText = w.word.trim();
              final japanese = tts.sanitizeKana(w.japanese);
              final text = wordText.isNotEmpty ? wordText : japanese;
              tts.speak(text);
            },
...
class _KanjiList extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final kanjis = _extractKanjis(word.word);
